...
var showInspiration = function (item) {
    ...
    var user = result.find('.name-text a')
...
// this function takes the answerer/user object returned by the StackOverflow request
...
var getInspiration = function (tags2) {
    ...
    $.ajax({
            url: '//api.stackexchange.com/2.2/tags/' + tags2 + '/top-answerers/all_time',
            data: request,
            dataType: 'jsonp',
            type: 'GET'
        })
...
$(document).ready(function () {
    ...
    $('.inspiration-getter').submit(function (e) {
        ...
        e.preventDefault();
        // get the value of the tags the user submitted
        var tags2 = $(this).find("input[name='tags2']").val();
